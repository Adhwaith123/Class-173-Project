...
AFRAME.registerComponent("markerhandler", {
  ...
  handleRatings: async function (dish) {
    ...
    if(currentOrders.length>=0&&currentOrders==dish.id){
      document.getElementById("rating-modal-div").style.display
      document.getElementById("rating-input").value="0"
      document.getElementById("feedback-input").value=""
      var saveRatingButton=document.getElementById("save-ratings-button")
      saveRatingButton.addEventListener("click",()=>{
        document.getElementById("rating-modal-div").style.display="none"
        var rating=getElementById("rating-input").value
        var feedback=getElementById("feedback-input").value
        firebase.firestore().collection("dishes").doc(dish.id)
        .update({
          last_rating:rating,
        ...
        .then(()=>{
          swal({
            ...
            text:"We home you liked the dish",
            time:2500,
            buttons:false
      ...
      swal({
        icon:"warning",
        title:"Oops",
        text:"No dish found to create ratings",
        time:2500,
        buttons:false
